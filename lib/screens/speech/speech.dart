              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Confidence: ${(_confidence * 100.0).toStringAsFixed(1)}%', style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),),
                      Text('WPM: ${((_confidence * 100.0)+20).toStringAsFixed(1)}', style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),),
  ...
  createDialog(BuildContext context){
    ...
    return showDialog(context: context, builder: (context){
      return AlertDialog(
        ...
        title: Text("Name this Presentation", style: TextStyle(
          color: blueText,
          fontWeight: FontWeight.bold
        ),),
